...
class SSEHandlers {
    ...
    constructor(context) {
        ...
        this.handlers = {
            ...
            'ROOM_MESSAGE': (data) => data.message.serverId === null ? this.user.privateRooms.textController.message(data) : this.room.textController.message(data),
